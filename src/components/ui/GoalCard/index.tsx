    ...
    <div className="flex min-h-356 w-full flex-col justify-between gap-20 rounded-[20px] bg-white p-24">
      <div className="flex flex-col gap-12">
        <div className="flex justify-between">
          <div className="flex min-w-0 flex-1 flex-row gap-12">
            <FlagFilled className="text-primary-600 size-24 shrink-0" />
      ...
      <div className="flex flex-1 flex-col justify-between gap-20">
        ...
        <Button
          variant={"outline"}
          size={"lg"}
          className="border-primary-500 flex h-48 w-full flex-row items-center justify-center gap-8 bg-white"
        >
          <Plus className="text-primary-600 size-16 shrink-0" />
